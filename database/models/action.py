...
class ActionModel(models.Model):
    ...
    # Relationship
    camera = fields.OneToOneField(
        "models.ZoneModel", related_name="camera_attendance", null=True
    )
    face = fields.ForeignKeyField(
        "models.FaceModel", related_name="face_tracking", null=True
    )
